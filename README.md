...
and 58.2-68.3 ms cold admission; two Node 24 CI runs measured 31.5-41.8 ms warm
and 99.8-129.2 ms cold with the same one-resume/seeded-start shape. These runs
